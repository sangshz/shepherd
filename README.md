...
export DEEPSEEK_API_KEY="your-deepseek-api-key"  # Set API Key
...
- **License**: MIT License
- **Author’s note**: Over 90% of the code was generated by AI, including the project name "Shepherd", which was also recommended by AI.
